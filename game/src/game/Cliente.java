...
public class Cliente {
	...
	public static void main(String[] args)  {
		...
		while(continuer) {
			...
			//Affichage
			System.out.println("Nomde de joueurs crées: "+Joueur.getCompteurJoueur());
			System.out.println("Liste des joueurs:");
			
			//Probleme ici, il faut relire le niveau pour placer le joueur au bon endroit

			niveau1.setElementSimple('1', j0.getx(), j0.gety());
